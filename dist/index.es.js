...
function Bt() {
  if (mt) return b;
  mt = 1;
  var v = Symbol.for("react.element"), f = Symbol.for("react.portal"), F = Symbol.for("react.fragment"), m = Symbol.for("react.strict_mode"), $ = Symbol.for("react.profiler"), ae = Symbol.for("react.provider"), oe = Symbol.for("react.context"), J = Symbol.for("react.forward_ref"), D = Symbol.for("react.suspense"), Z = Symbol.for("react.memo"), N = Symbol.for("react.lazy"), B = Symbol.iterator;
  function ie(n) {
  ...
  function ue(n, u, E) {
    this.props = n, this.context = u, this.refs = qe, this.updater = E || re;
  }
  ...
  _e.constructor = M, fe(_e, ue.prototype), _e.isPureReactComponent = !0;
  var le = Array.isArray, W = Object.prototype.hasOwnProperty, ee = { current: null }, de = { key: !0, ref: !0, __self: !0, __source: !0 };
  function ye(n, u, E) {
    var C, w = {}, A = null, k = null;
    if (u != null) for (C in u.ref !== void 0 && (k = u.ref), u.key !== void 0 && (A = "" + u.key), u) W.call(u, C) && !de.hasOwnProperty(C) && (w[C] = u[C]);
    var T = arguments.length - 2;
    if (T === 1) w.children = E;
    else if (1 < T) {
      for (var x = Array(T), Y = 0; Y < T; Y++) x[Y] = arguments[Y + 2];
      w.children = x;
    }
    if (n && n.defaultProps) for (C in T = n.defaultProps, T) w[C] === void 0 && (w[C] = T[C]);
    return { $$typeof: v, type: n, key: A, ref: k, props: w, _owner: ee.current };
  }
  function we(n, u) {
    return { $$typeof: v, type: n.type, key: u, ref: n.ref, props: n.props, _owner: n._owner };
  }
  function je(n) {
  ...
  function te(n, u, E, C, w) {
    ...
    if (k) return k = n, w = w(k), n = C === "" ? "." + X(k, 0) : C, le(w) ? (E = "", n != null && (E = n.replace(xe, "$&/") + "/"), te(w, u, E, "", function(Y) {
      return Y;
    })) : w != null && (je(w) && (w = we(w, E + (!w.key || k && k.key === w.key ? "" : ("" + w.key).replace(xe, "$&/") + "/") + n)), u.push(w)), 1;
    if (k = 0, C = C === "" ? "." : C + ":", le(n)) for (var T = 0; T < n.length; T++) {
      A = n[T];
      var x = C + X(A, T);
      k += te(A, u, E, x, w);
    }
    else if (x = ie(n), typeof x == "function") for (n = x.call(n), T = 0; !(A = n.next()).done; ) A = A.value, x = C + X(A, T++), k += te(A, u, E, x, w);
    else if (A === "object") throw u = String(n), Error("Objects are not valid as a React child (found: " + (u === "[object Object]" ? "object with keys {" + Object.keys(n).join(", ") + "}" : u) + "). If you meant to render a collection of children, use an array instead.");
    return k;
  }
  function G(n, u, E) {
    if (n == null) return n;
    var C = [], w = 0;
    return te(n, C, "", "", function(A) {
      return u.call(E, A, w++);
    }), C;
  }
  function ce(n) {
  ...
  var p = { current: null }, pe = { transition: null }, Oe = { ReactCurrentDispatcher: p, ReactCurrentBatchConfig: pe, ReactCurrentOwner: ee };
  function he() {
    throw Error("act(...) is not supported in production builds of React.");
  }
  return b.Children = { map: G, forEach: function(n, u, E) {
    G(n, function() {
    ...
    return n;
  } }, b.Component = ue, b.Fragment = F, b.Profiler = $, b.PureComponent = M, b.StrictMode = m, b.Suspense = D, b.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = Oe, b.act = he, b.cloneElement = function(n, u, E) {
    if (n == null) throw Error("React.cloneElement(...): The argument must be a React element, but you passed " + n + ".");
    var C = fe({}, n.props), w = n.key, A = n.ref, k = n._owner;
    if (u != null) {
      if (u.ref !== void 0 && (A = u.ref, k = ee.current), u.key !== void 0 && (w = "" + u.key), n.type && n.type.defaultProps) var T = n.type.defaultProps;
      for (x in u) W.call(u, x) && !de.hasOwnProperty(x) && (C[x] = u[x] === void 0 && T !== void 0 ? T[x] : u[x]);
    }
    var x = arguments.length - 2;
    if (x === 1) C.children = E;
    else if (1 < x) {
      T = Array(x);
      for (var Y = 0; Y < x; Y++) T[Y] = arguments[Y + 2];
      C.children = T;
    }
    return { $$typeof: v, type: n.type, key: w, ref: A, props: C, _owner: k };
  ...
  }, b.isValidElement = je, b.lazy = function(n) {
  ...
  }, b.unstable_act = he, b.useCallback = function(n, u) {
  ...
  }, b.useImperativeHandle = function(n, u, E) {
    return p.current.useImperativeHandle(n, u, E);
  ...
  }, b.useReducer = function(n, u, E) {
    return p.current.useReducer(n, u, E);
  }, b.useRef = function(n) {
    return p.current.useRef(n);
  }, b.useState = function(n) {
    return p.current.useState(n);
  }, b.useSyncExternalStore = function(n, u, E) {
    return p.current.useSyncExternalStore(n, u, E);
...
var gt;
function Gt() {
  return gt || (gt = 1, function(v, f) {
    process.env.NODE_ENV !== "production" && function() {
      typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStart(new Error());
      var F = "18.3.1", m = Symbol.for("react.element"), $ = Symbol.for("react.portal"), ae = Symbol.for("react.fragment"), oe = Symbol.for("react.strict_mode"), J = Symbol.for("react.profiler"), D = Symbol.for("react.provider"), Z = Symbol.for("react.context"), N = Symbol.for("react.forward_ref"), B = Symbol.for("react.suspense"), ie = Symbol.for("react.suspense_list"), re = Symbol.for("react.memo"), fe = Symbol.for("react.lazy"), qe = Symbol.for("react.offscreen"), ue = Symbol.iterator, se = "@@iterator";
      function M(e) {
      ...
      var je = !1, Ye = !1, xe = !1, X = !1, te = !1, G = {
        ReactCurrentDispatcher: _e,
        ReactCurrentBatchConfig: le,
        ReactCurrentOwner: ee
      };
      G.ReactDebugCurrentFrame = de, G.ReactCurrentActQueue = W;
      function ce(e) {
        {
      ...
      function he(e, r) {
        {
          ...
          if (Oe[l])
            return;
          p("Can't call %s on a component that is not yet mounted. This is a no-op, but it might indicate a bug in your application. Instead, assign to `this.state` directly or define a `state = {};` class property with the desired state in the %s component.", r, o), Oe[l] = !0;
        }
      }
      var n = {
        /**
      ...
      var Y = x.prototype = new T();
      Y.constructor = x, u(Y, C.prototype), Y.isPureReactComponent = !0;
      function Er() {
        var e = {
          current: null
        };
      ...
      function ve(e) {
        ...
        if (typeof e == "object")
          switch (e.$$typeof) {
            ...
            case fe: {
              var l = e, y = l._payload, d = l._init;
              try {
                return ve(d(y));
              } catch {
                return null;
      ...
      function Sr(e, r, a) {
        var o, l = {}, y = null, d = null, g = null, S = null;
        if (r != null) {
          ze(r) && (d = r.ref, ar(r)), Ee(r) && (Te(r.key), y = "" + r.key), g = r.__self === void 0 ? null : r.__self, S = r.__source === void 0 ? null : r.__source;
          for (o in r)
            Pe.call(r, o) && !Le.hasOwnProperty(o) && (l[o] = r[o]);
        }
        var P = arguments.length - 2;
        if (P === 1)
          l.children = a;
        else if (P > 1) {
          for (var I = Array(P), q = 0; q < P; q++)
            I[q] = arguments[q + 2];
          Object.freeze && Object.freeze(I), l.children = I;
        }
        if (e && e.defaultProps) {
        ...
        return Ae(e, y, d, g, S, ee.current, l);
      }
      function wr(e, r) {
      ...
      function jr(e, r, a) {
        ...
        var o, l = u({}, e.props), y = e.key, d = e.ref, g = e._self, S = e._source, P = e._owner;
        if (r != null) {
          ze(r) && (d = r.ref, P = ee.current), Ee(r) && (Te(r.key), y = "" + r.key);
          var I;
          e.type && e.type.defaultProps && (I = e.type.defaultProps);
          for (o in r)
            Pe.call(r, o) && !Le.hasOwnProperty(o) && (r[o] === void 0 && I !== void 0 ? l[o] = I[o] : l[o] = r[o]);
        }
        var q = arguments.length - 2;
        if (q === 1)
          l.children = a;
        else if (q > 1) {
          for (var V = Array(q), z = 0; z < q; z++)
            V[z] = arguments[z + 2];
          l.children = V;
        }
        return Ae(e.type, y, d, g, S, P, l);
      }
      function Re(e) {
      ...
      function Fe(e, r) {
        return typeof e == "object" && e !== null && e.key != null ? (Te(e.key), Or("" + e.key)) : r.toString(36);
      }
      function Ce(e, r, a, o, l) {
        var y = typeof e;
        ...
        if (d) {
          var g = e, S = l(g), P = o === "" ? or + Fe(g, 0) : o;
          if ($e(S)) {
            var I = "";
            P != null && (I = me(P) + "/"), Ce(S, r, I, "", function(Yt) {
              return Yt;
            });
          } else S != null && (Re(S) && (S.key && (!g || g.key !== S.key) && Te(S.key), S = wr(
            S,
        ...
        var q, V, z = 0, K = o === "" ? or : o + xr;
        if ($e(e))
          for (var gr = 0; gr < e.length; gr++)
            q = e[gr], V = K + Fe(q, gr), z += Ce(q, r, a, V, l);
        else {
          var Wr = M(e);
          if (typeof Wr == "function") {
            var vt = e;
            Wr === vt.entries && (Ue || ce("Using Maps as children is not supported. Use an array of keyed ReactElements instead."), Ue = !0);
            for (var Nt = Wr.call(vt), yt, Wt = 0; !(yt = Nt.next()).done; )
              q = yt.value, V = K + Fe(q, Wt++), z += Ce(q, r, a, V, l);
          } else if (y === "object") {
            var ht = String(e);
      ...
      function Pr(e) {
        if (e._status === Ie) {
          ...
          if (a.then(function(y) {
            if (e._status === Be || e._status === Ie) {
              var d = e;
              d._status = Ge, d._result = y;
            }
          }, function(y) {
            if (e._status === Be || e._status === Ie) {
              var d = e;
              d._status = cr, d._result = y;
            }
          }), e._status === Ie) {
            var o = e;
        ...
        if (e._status === Ge) {
          var l = e._result;
          return l === void 0 && p(`lazy: Expected the result of a dynamic import() call. Instead received: %s

Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))

Did you accidentally put curly braces around the import?`, l), "default" in l || p(`lazy: Expected the result of a dynamic import() call. Instead received: %s
...
Your code should look like: 
  const MyComponent = lazy(() => import('./MyComponent'))`, l), l.default;
        ...
        };
        {
          ...
          Object.defineProperties(a, {
            defaultProps: {
              ...
              set: function(y) {
                p("React.lazy(...): It is not supported to assign `defaultProps` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."), o = y, Object.defineProperty(a, "defaultProps", {
                  enumerable: !0
                });
              }
            },
            propTypes: {
              ...
              set: function(y) {
                p("React.lazy(...): It is not supported to assign `propTypes` to a lazy component import. Either specify them where the component is defined, or create a wrapping component around it."), l = y, Object.defineProperty(a, "propTypes", {
                  enumerable: !0
                });
              }
            }
      ...
      function t(e) {
        return !!(typeof e == "string" || typeof e == "function" || e === ae || e === J || te || e === oe || e === B || e === ie || X || e === qe || je || Ye || xe || typeof e == "object" && e !== null && (e.$$typeof === fe || e.$$typeof === re || e.$$typeof === D || e.$$typeof === Z || e.$$typeof === N || // This needs to include all possible module reference object
...
See https://reactjs.org/link/invalid-hook-call for tips about how to debug and fix this problem.`), e;
      ...
      function St() {
        {
          if (Ke === 0) {
            Gr = console.log, Hr = console.info, Kr = console.warn, Jr = console.error, Xr = console.group, Qr = console.groupCollapsed, Zr = console.groupEnd;
            var e = {
              configurable: !0,
              enumerable: !0,
              value: et,
      ...
      var qr = G.ReactCurrentDispatcher, $r;
      function dr(e, r, a) {
        {
          if ($r === void 0)
            try {
...
` + $r + e;
      ...
      function rt(e, r) {
        ...
        var y;
        y = qr.current, qr.current = null, St();
        try {
          if (r) {
            var d = function() {
              throw Error();
...
`), S = o.stack.split(`
`), P = g.length - 1, I = S.length - 1; P >= 1 && I >= 0 && g[P] !== S[I]; )
              I--;
            for (; P >= 1 && I >= 0; P--, I--)
              if (g[P] !== S[I]) {
                if (P !== 1 || I !== 1)
...
` + g[P].replace(" at new ", " at ");
                      return e.displayName && q.includes("<anonymous>") && (q = q.replace("<anonymous>", e.displayName)), typeof e == "function" && pr.set(e, q), q;
                    }
                  while (P >= 1 && I >= 0);
                break;
              }
          ...
          Mr = !1, qr.current = y, wt(), Error.prepareStackTrace = l;
        }
        var V = e ? e.displayName || e.name : "", z = V ? dr(V) : "";
      ...
      function vr(e, r, a) {
        ...
        if (typeof e == "object")
          switch (e.$$typeof) {
            ...
            case fe: {
              var o = e, l = o._payload, y = o._init;
              try {
                return vr(y(l), r, a);
              } catch {
              }
      ...
      function Tt(e, r, a, o, l) {
        {
          ...
          for (var d in e)
            if (y(e, d)) {
              ...
              g && !(g instanceof Error) && (yr(l), p("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", o || "React class", a, d, typeof g), yr(null)), g instanceof Error && !(g.message in tt) && (tt[g.message] = !0, yr(l), p("Failed %s type: %s", a, g.message), yr(null));
            }
        }
      }
      function Ne(e) {
...
Check the top-level render call using <` + a + ">.");
      ...
      function it(e, r) {
        if (!(!e._store || e._store.validated || e.key != null)) {
          ...
          if (!ot[a]) {
            ot[a] = !0;
            var o = "";
            e && e._owner && e._owner !== ee.current && (o = " It was passed a child from " + ve(e._owner.type) + "."), Ne(e), p('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', a, o), Ne(null);
          }
        }
      }
      function ut(e, r) {
        if (typeof e == "object") {
          if ($e(e))
            ...
            if (typeof l == "function" && l !== e.entries)
              for (var y = l.call(e), d; !(d = y.next()).done; )
                Re(d.value) && it(d.value, r);
          }
        }
      }
      function st(e) {
      ...
      function Ft(e) {
        {
          for (var r = Object.keys(e.props), a = 0; a < r.length; a++) {
            var o = r[a];
            if (o !== "children" && o !== "key") {
              Ne(e), p("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", o), Ne(null);
              break;
            }
          }
      ...
      function lt(e, r, a) {
        ...
        if (!o) {
          ...
          y ? l += y : l += at();
          var d;
          e === null ? d = "null" : $e(e) ? d = "array" : e !== void 0 && e.$$typeof === m ? (d = "<" + (ve(e.type) || "Unknown") + " />", l = " Did you accidentally export a JSX literal instead of a component?") : d = typeof e, p("React.createElement: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", d, l);
        }
        var g = Sr.apply(this, arguments);
        if (g == null)
          return g;
        if (o)
          for (var S = 2; S < arguments.length; S++)
            ut(arguments[S], e);
        return e === ae ? Ft(g) : st(g), g;
      }
      var ct = !1;
      function Dt(e) {
        var r = lt.bind(null, e);
        return r.type = e, ct || (ct = !0, ce("React.createFactory() is deprecated and will be removed in a future major release. Consider using JSX or use React.createElement() directly instead.")), Object.defineProperty(r, "type", {
          enumerable: !1,
          get: function() {
      ...
      function It(e, r, a) {
        for (var o = jr.apply(this, arguments), l = 2; l < arguments.length; l++)
          ut(arguments[l], o.type);
        return st(o), o;
      }
      function qt(e, r) {
        var a = le.transition;
        ...
        if (hr === null)
          try {
            ...
            hr = function(l) {
              ...
              y.port1.onmessage = l, y.port2.postMessage(void 0);
            };
          }
        return hr(e);
      }
      ...
      function pt(e) {
        {
          ...
          if (o !== null && typeof o == "object" && typeof o.then == "function") {
            var y = o, d = !1, g = {
              then: function(V, z) {
                d = !0, y.then(function(K) {
                  mr(r), We === 0 ? Vr(K, V, z) : V(K);
                }, function(K) {
                  mr(r), z(K);
                });
              }
            ...
            return !dt && typeof Promise < "u" && Promise.resolve().then(function() {
              ...
              d || (dt = !0, p("You called act(async () => ...) without await. This could lead to unexpected testing behaviour, interleaving multiple act calls and mixing their scopes. You should - await act(async () => ...);"));
            }), g;
          } else {
            var S = o;
            if (mr(r), We === 0) {
              var P = W.current;
              P !== null && (Nr(P), W.current = null);
              var I = {
                then: function(V, z) {
                  W.current === null ? (W.current = [], Vr(S, V, z)) : V(S);
                }
              };
              return I;
            } else {
      ...
      function mr(e) {
        e !== We - 1 && p("You seem to have overlapping act() calls, this is not supported. Be sure to await previous act() calls before making a new one. "), We = e;
      }
      function Vr(e, r, a) {
        {
          var o = W.current;
      ...
      f.Children = Ut, f.Component = C, f.Fragment = ae, f.Profiler = J, f.PureComponent = x, f.StrictMode = oe, f.Suspense = B, f.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = G, f.act = pt, f.cloneElement = Lt, f.createContext = lr, f.createElement = Mt, f.createFactory = Vt, f.createRef = Er, f.forwardRef = Fr, f.isValidElement = Re, f.lazy = Ar, f.memo = i, f.startTransition = qt, f.unstable_act = pt, f.useCallback = U, f.useContext = h, f.useDebugValue = ge, f.useDeferredValue = He, f.useEffect = _, f.useId = Dr, f.useImperativeHandle = Se, f.useInsertionEffect = H, f.useLayoutEffect = L, f.useMemo = ne, f.useReducer = O, f.useRef = R, f.useState = j, f.useSyncExternalStore = Ir, f.useTransition = Q, f.version = F, typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ < "u" && typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop == "function" && __REACT_DEVTOOLS_GLOBAL_HOOK__.registerInternalModuleStop(new Error());
    }();
  }(Qe, Qe.exports)), Qe.exports;
}
var _t;
function Br() {
  return _t || (_t = 1, process.env.NODE_ENV === "production" ? _r.exports = Bt() : _r.exports = Gt()), _r.exports;
}
/**
 * @license React
...
function Ht() {
  if (bt) return Je;
  bt = 1;
  var v = Br(), f = Symbol.for("react.element"), F = Symbol.for("react.fragment"), m = Object.prototype.hasOwnProperty, $ = v.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, ae = { key: !0, ref: !0, __self: !0, __source: !0 };
  function oe(J, D, Z) {
    var N, B = {}, ie = null, re = null;
    Z !== void 0 && (ie = "" + Z), D.key !== void 0 && (ie = "" + D.key), D.ref !== void 0 && (re = D.ref);
    for (N in D) m.call(D, N) && !ae.hasOwnProperty(N) && (B[N] = D[N]);
    if (J && J.defaultProps) for (N in D = J.defaultProps, D) B[N] === void 0 && (B[N] = D[N]);
    return { $$typeof: f, type: J, key: ie, ref: re, props: B, _owner: $.current };
  }
  return Je.Fragment = F, Je.jsx = oe, Je.jsxs = oe, Je;
}
var Xe = {};
/**
 * @license React
...
function Kt() {
  return Et || (Et = 1, process.env.NODE_ENV !== "production" && function() {
    var v = Br(), f = Symbol.for("react.element"), F = Symbol.for("react.portal"), m = Symbol.for("react.fragment"), $ = Symbol.for("react.strict_mode"), ae = Symbol.for("react.profiler"), oe = Symbol.for("react.provider"), J = Symbol.for("react.context"), D = Symbol.for("react.forward_ref"), Z = Symbol.for("react.suspense"), N = Symbol.for("react.suspense_list"), B = Symbol.for("react.memo"), ie = Symbol.for("react.lazy"), re = Symbol.for("react.offscreen"), fe = Symbol.iterator, qe = "@@iterator";
    function ue(t) {
    ...
    function _e(t, i, s) {
      {
        var h = se.ReactDebugCurrentFrame, j = h.getStackAddendum();
        j !== "" && (i += "%s", s = s.concat([j]));
    ...
    var le = !1, W = !1, ee = !1, de = !1, ye = !1, we;
    we = Symbol.for("react.module.reference");
    function je(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === m || t === ae || ye || t === $ || t === Z || t === N || de || t === re || le || W || ee || typeof t == "object" && t !== null && (t.$$typeof === ie || t.$$typeof === B || t.$$typeof === oe || t.$$typeof === J || t.$$typeof === D || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
      ...
      if (typeof t == "object")
        switch (t.$$typeof) {
          ...
          case B:
            ...
            return h !== null ? h : X(t.type) || "Memo";
          case ie: {
            var j = t, O = j._payload, R = j._init;
            try {
              return X(R(O));
            } catch {
              return null;
    ...
    var te = Object.assign, G = 0, ce, p, pe, Oe, he, n, u;
    function E() {
    }
    ...
    function C() {
      {
        if (G === 0) {
          ce = console.log, p = console.info, pe = console.warn, Oe = console.error, he = console.group, n = console.groupCollapsed, u = console.groupEnd;
          var t = {
            configurable: !0,
            enumerable: !0,
            value: E,
...
`), H = h.stack.split(`
`), L = _.length - 1, U = H.length - 1; L >= 1 && U >= 0 && _[L] !== H[U]; )
            U--;
          for (; L >= 1 && U >= 0; L--, U--)
            if (_[L] !== H[U]) {
              if (L !== 1 || U !== 1)
...
` + _[L].replace(" at new ", " at ");
        ...
        x = !1, A.current = O, w(), Error.prepareStackTrace = j;
      }
      var Se = t ? t.displayName || t.name : "", ge = Se ? T(Se) : "";
    ...
    function Me(t, i, s) {
      ...
      if (typeof t == "object")
        switch (t.$$typeof) {
          ...
          case ie: {
            var h = t, j = h._payload, O = h._init;
            try {
              return Me(O(j), i, s);
            } catch {
            }
    ...
    var be = Object.prototype.hasOwnProperty, Te = {}, er = se.ReactDebugCurrentFrame;
    function ke(t) {
      if (t) {
          ...
          if (O(t, R)) {
            ...
            try {
              if (typeof t[R] != "function") {
                var H = Error((h || "React class") + ": " + s + " type `" + R + "` is invalid; it must be a function, usually from the `prop-types` package, but received `" + typeof t[R] + "`.This often happens because of typos such as `PropTypes.function` instead of `PropTypes.func`.");
                throw H.name = "Invariant Violation", H;
              }
              _ = t[R](i, R, h, s, null, "SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED");
            } catch (L) {
              _ = L;
            }
            _ && !(_ instanceof Error) && (ke(j), M("%s: type specification of %s `%s` is invalid; the type checker function must return `null` or an `Error` but returned a %s. You may have forgotten to pass an argument to the type checker creator (arrayOf, instanceOf, objectOf, oneOf, oneOfType, and shape all require an argument).", h || "React class", s, R, typeof _), ke(null)), _ instanceof Error && !(_.message in Te) && (Te[_.message] = !0, ke(j), M("Failed %s type: %s", s, _.message), ke(null));
          }
      }
    }
    ...
    var Ee = se.ReactCurrentOwner, Cr = {
      key: !0,
      ref: !0,
      __self: !0,
      __source: !0
    ...
    function jr(t, i) {
      if (typeof t.ref == "string" && Ee.current && i && Ee.current.stateNode !== i) {
        var s = X(Ee.current.type);
        Ae[s] || (M('Component "%s" contains the string ref "%s". Support for string refs will be removed in a future major release. This case cannot be automatically converted to an arrow function. We ask you to manually fix this case by using useRef() or createRef() instead. Learn more about using refs safely here: https://reactjs.org/link/strict-mode-string-ref', X(Ee.current.type), t.ref), Ae[s] = !0);
      }
    }
    function Re(t, i) {
      {
        var s = function() {
          nr || (nr = !0, M("%s: `key` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", i));
        };
    ...
    function or(t, i) {
      {
        var s = function() {
          ar || (ar = !0, M("%s: `ref` is not a prop. Trying to access it will result in `undefined` being returned. If you need to access the same value within the child component, you should pass it as a different prop. (https://reactjs.org/link/special-props)", i));
        };
    ...
    function Or(t, i, s, h, j) {
      {
        var O, R = {}, _ = null, H = null;
        s !== void 0 && (ze(s), _ = "" + s), wr(i) && (ze(i.key), _ = "" + i.key), Sr(i) && (H = i.ref, jr(i, j));
        for (O in i)
          be.call(i, O) && !Cr.hasOwnProperty(O) && (R[O] = i[O]);
        if (t && t.defaultProps) {
        ...
        return xr(t, _, H, j, h, Ee.current, R);
      }
    }
    var Ue = se.ReactCurrentOwner, ir = se.ReactDebugCurrentFrame;
    function me(t) {
      if (t) {
        var i = t._owner, s = Me(t.type, t._source, i ? i.type : null);
    ...
    function sr(t, i) {
      {
        ...
        ur[s] = !0;
        var h = "";
        t && t._owner && t._owner !== Ue.current && (h = " It was passed a child from " + X(t._owner.type) + "."), me(t), M('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', s, h), me(null);
      }
    }
    function lr(t, i) {
      {
        ...
        if (Le(t))
          ...
          if (typeof j == "function" && j !== t.entries)
            for (var O = j.call(t), R; !(R = O.next()).done; )
              Ce(R.value) && sr(R.value, i);
        }
      }
    }
    function Ie(t) {
    ...
    function Be(t) {
      {
        for (var i = Object.keys(t.props), s = 0; s < i.length; s++) {
          var h = i[s];
          if (h !== "children" && h !== "key") {
            me(t), M("Invalid prop `%s` supplied to `React.Fragment`. React.Fragment can only have `key` and `children` props.", h), me(null);
            break;
          }
        }
        t.ref !== null && (me(t), M("Invalid attribute `ref` supplied to `React.Fragment`."), me(null));
      }
    }
    var Ge = {};
    function cr(t, i, s, h, j, O) {
      {
        var R = je(t);
        if (!R) {
          var _ = "";
          ...
          H ? _ += H : _ += De();
          var L;
          t === null ? L = "null" : Le(t) ? L = "array" : t !== void 0 && t.$$typeof === f ? (L = "<" + (X(t.type) || "Unknown") + " />", _ = " Did you accidentally export a JSX literal instead of a component?") : L = typeof t, M("React.jsx: type is invalid -- expected a string (for built-in components) or a class/function (for composite components) but got: %s.%s", L, _);
        }
        var U = Or(t, i, s, j, O);
        if (U == null)
          return U;
...
React keys must be passed directly to JSX without using spread:
  let props = %s;
  <%s key={someKey} {...props} />`, He, ge, Dr, ge), Ge[ge + He] = !0;
          }
        }
        return t === m ? Be(U) : Ie(U), U;
      }
    }
    function Pr(t, i, s) {
      return cr(t, i, s, !0);
    ...
    var Fr = Ar, fr = Pr;
    Xe.Fragment = m, Xe.jsx = Fr, Xe.jsxs = fr;
  }()), Xe;
}
process.env.NODE_ENV === "production" ? zr.exports = Ht() : zr.exports = Kt();
var c = zr.exports;
function Jt({ to: v }) {
  return /* @__PURE__ */ c.jsxs(
    "a",
    {
      ...
      children: [
        /* @__PURE__ */ c.jsx("span", { className: "sr-only", children: "View source on GitHub" }),
        /* @__PURE__ */ c.jsxs("svg", { width: "80", height: "80", viewBox: "0 0 250 250", "aria-hidden": "true", children: [
          /* @__PURE__ */ c.jsx("path", { d: "M0,0 L115,115 L130,115 L142,142 L250,250 L250,0 Z" }),
          /* @__PURE__ */ c.jsx(
            "path",
            {
...
var Rt = Br();
const br = /* @__PURE__ */ zt(Rt), Xt = Rt.createContext(null);
function Ct(v) {
  var f, F, m = "";
  if (typeof v == "string" || typeof v == "number") m += v;
  else if (typeof v == "object") if (Array.isArray(v)) {
    var $ = v.length;
    for (f = 0; f < $; f++) v[f] && (F = Ct(v[f])) && (m && (m += " "), m += F);
  } else for (F in v) v[F] && (m && (m += " "), m += F);
  return m;
}
function Qt() {
  for (var v, f, F = 0, m = "", $ = arguments.length; F < $; F++) (v = arguments[F]) && (f = Ct(v)) && (m && (m += " "), m += f);
  return m;
}
const Zt = ({
  asChild: v,
  ...
  const oe = F;
  if (!v)
    return /* @__PURE__ */ c.jsx(oe, { ...$, children: m });
  if (br.Children.count(m) > 1)
    throw new Error("Only one child allowed");
  if (br.isValidElement(m)) {
    const Z = f ? Qt((J = m == null ? void 0 : m.props) == null ? void 0 : J.className, $ == null ? void 0 : $.className) : (D = m == null ? void 0 : m.props) == null ? void 0 : D.className;
    return br.cloneElement(m, {
      ...$,
      ref: ae,
  ...
  return null;
}, en = br.forwardRef(Zt), rn = (v) => /* @__PURE__ */ c.jsxs(
  "svg",
  {
    ...
    ...v,
    children: [
      /* @__PURE__ */ c.jsxs("g", { clipPath: "url(#sequence-boilerplate-logo_svg__a)", children: [
        /* @__PURE__ */ c.jsx(
          "mask",
          {
            ...
            children: /* @__PURE__ */ c.jsx("path", { fill: "#fff", d: "M35.03 0H0v28h35.03z" })
          }
        ),
        /* @__PURE__ */ c.jsxs("g", { mask: "url(#sequence-boilerplate-logo_svg__b)", children: [
          /* @__PURE__ */ c.jsx(
            "path",
            {
              fill: "#111",
      ...
      /* @__PURE__ */ c.jsxs("defs", { children: [
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#1D273D" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#0D0F13" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            gradientUnits: "userSpaceOnUse",
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#4462FE" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#7D69FA" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            gradientUnits: "userSpaceOnUse",
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#3757FD" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#6980FA" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            gradientUnits: "userSpaceOnUse",
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#2447FF" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#6980FA" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            gradientUnits: "userSpaceOnUse",
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#BC3EE6" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#D972F1" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            gradientUnits: "userSpaceOnUse",
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#29BDFF" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#96E7FB" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            gradientUnits: "userSpaceOnUse",
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#23BBFF" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#85E7FF" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsxs(
        ...
        /* @__PURE__ */ c.jsxs(
          "linearGradient",
          {
            ...
            gradientUnits: "userSpaceOnUse",
            children: [
              /* @__PURE__ */ c.jsx("stop", { stopColor: "#6634FF" }),
              /* @__PURE__ */ c.jsx("stop", { offset: 1, stopColor: "#9C6DFF" })
            ]
          }
        ),
        /* @__PURE__ */ c.jsx("clipPath", { id: "sequence-boilerplate-logo_svg__a", children: /* @__PURE__ */ c.jsx("path", { fill: "#fff", d: "M0 0h151.273v28H0z" }) })
      ] })
    ]
  }
), tn = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  __proto__: null,
  SequenceBoilerplateLogo: rn
}, Symbol.toStringTag, { value: "Module" })), Yr = tn;
function nn({
  name: v,
  alt: f = void 0,
  className: F = "",
  ...
  return /* @__PURE__ */ c.jsx(
    en,
    {
      ...
      "aria-label": f || void 0,
      focusable: "false",
      className: `${F} flex-shrink-0`.trim(),
      asChild: !0,
      ...m,
...
function an({
  ...
  return /* @__PURE__ */ c.jsxs("div", { className: "flex flex-col gap-4", children: [
    ...
    /* @__PURE__ */ c.jsx("h1", { className: "text-40 font-bold", children: v }),
    /* @__PURE__ */ c.jsx("p", { className: "text-14 font-bold", children: f })
  ] });
}
function on({
  githubUrl: v,
  ...
  return /* @__PURE__ */ c.jsxs(
    Xt.Provider,
    {
      value: { githubUrl: v, name: f, description: F, useAuth: m },
      children: [
        v ? /* @__PURE__ */ c.jsx(Jt, { to: v }) : null,
        /* @__PURE__ */ c.jsx(an, { name: f, description: F }),
        /* @__PURE__ */ c.jsx("div", { className: "py-8", children: $ }),
        /* @__PURE__ */ c.jsx("div", { className: "text-14 font-medium", children: /* @__PURE__ */ c.jsxs("p", { children: [
...
function un({ children: v }) {
  return /* @__PURE__ */ c.jsx("div", { id: "root", children: v });
}
export {
  on as SequenceDemoKit,
  un as SsrRoot
};
